...
const Footer = () => {
  return (
    <footer className="bg-apple-ultra-light py-20">
      <div className="max-w-7xl mx-auto container-padding">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            />
            <p className="text-apple-gray text-sm leading-relaxed max-w-md">
              Transform your paper receipts into digital warranties. Never lose track of your purchases again.
            </p>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-apple-gray/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-apple-gray">
              © 2024 eWarrants. All rights reserved.
            </p>
            <div className="flex gap-6">
              <a href="#" className="text-apple-gray hover:text-apple-dark transition-colors">
